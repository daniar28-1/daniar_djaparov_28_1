...
create_product(connection, ('Чипсы', 80.90, 3))
create_product(connection, ('Гамбургер', 120.12, 7))
create_product(connection, ('Мыло детское', 56.90, 9))
create_product(connection, ('Вода Asu', 36.15, 4))
create_product(connection, ('Asu с малиной', 49.99, 9))
create_product(connection, ('Шоколад', 120.34, 15))
create_product(connection, ('Печенье шоколадное', 115.58, 7))
create_product(connection, ('Овсяное печенье', 138.12, 15))
